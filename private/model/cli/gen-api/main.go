...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/catenoid-company/aws-sdk-go/service", "namespace to generate service client Go code import path under")
	flag.Parse()
